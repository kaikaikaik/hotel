		...
		<div class="mar1000 clearfix">
			...
			<div class="rights">
				<div class="path path_nomar">
					<label>酒店新闻</label><span>当前位置：首页 &gt; 酒店新闻</span>
				</div>
				...
				<%News news = (News)request.getAttribute("news"); %>
					...
					<table width="700" border="0" align="center" cellpadding="0"
						...
						<tbody>
							<tr>
								<td height="30" align="center">来源：<%=news.getFrom1() %>
									发布时间：<%=news.getTime()%></td>
							</tr>
						</tbody>
					</table>
					<div class="contents">

	...
	<div class="content">
		<div class="mar1000 clearfix">
			...
			<div class="rights">
        	    ...
        	    <div class="news_item">  
	            	<div class="news_info">
	                	<h2><span>${hotlist.time}</span><a href="HotDetailServlet?id=${hotlist.id}">${hotlist.title}</a></h2>
	                </div>      		       
       			</div>
            ...
            <a href="HotCultureListServlet?current=1">首页</a>
            <a href="HotCultureListServlet?current=${current-1}">上一页</a>
            <a href="HotCultureListServlet?current=${current+1}">下一页</a>
            <a href="HotCultureListServlet?current=${total}">尾页</a><br>

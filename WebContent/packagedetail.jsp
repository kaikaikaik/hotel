<%@page import="com.icss.vo.Packages"%>
	...
	<div class="content">
		<div class="mar1000 clearfix">
			...
			<div class="lefts">
				<div class="tree">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tbody>
							<tr>
								<td><img src="images/nei_3.jpg" width="233"
									height="92"></td>
							</tr>
						</tbody>
					</table>
			...
			<div class="rights">
				...
				<%Packages pack = (Packages)request.getAttribute("package"); %>
				<div class="conten">
					<h1><%=pack.getTitle() %></h1>
					<table width="700" border="0" align="center" cellpadding="0"
						cellspacing="0"
						style="border-top: 1px #685745 dotted; border-bottom: 1px #685745 dotted;">
						<tbody>
							<tr>
								<td height="30" align="center">来源：<%=pack.getFrom1()%>
									发布时间：<%=pack.getTime()%></td>
							</tr>
						</tbody>
					</table>
					<div class="contents">

<%@page import="com.icss.vo.InfoList"%>
...
<div class="content">
	<div class="mar1000 clearfix">
		...
		<div class="lefts">
      	...
      	<div class="rights">
        	<div class="path path_nomar"></div>
            
            <div class="conten">
            <%InfoList info = (InfoList)request.getAttribute("info");%>
            <h1><%=info.getTitle() %></h1>
            <span></span>
            <div class="contents">
            <p align="center"><img src="<%=info.getImg() %>" width="476" height="267"  alt=""/></p>

...
%>
 ...
 %>
        ...
        <br> <span class="s1">用户名:</span> <span class="s2">
						...
						<li class="clearfix"><span class="s1">密 码:</span> <span class="s2">
						<input type="password" class="valid_ipt" id="pwd" name="pwd" /> </span> <span id="pwdmsg"></span></li>
					...
					<div class="yes_rule">
						<select id="timelength" name="timelength">
							...
							<option value="7">一周内无需登录</option>
							<option value="14">两周内无需登录</option>
						</select> <a href="findpassword.jsp" style="margin-left: 70px">忘记密码？</a>
					</div>
					<div class="btn_area clearfix">
						<input type="button" id="sub_btn" class="btn1" onclick="validate()" value="登 录">
					</div>
				</div>
				</form>
			</div>
